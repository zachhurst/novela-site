...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Updating my bio, avatar, adding new authors, configuring site meta-data, etc. was literally easier than editing a Myspace page. The posts are written in Markdown and the theme transforms them to HTML for me at compile time. 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;It's called [Themes](https://www.gatsbyjs.org/docs/themes/) for [Gatsby JS](https://www.gatsbyjs.org/) (one of the many **static, progressive web app generators**). The beauty of JAMstack solutions like Gatsby is that they follow the micro-front end trend which encapsulates feature rich web apps as Node JS packages and enables developers to share them for instant customization and deployment. In this case, a blogging app called Novella was published as a theme and I was able to download, install it and start manipulating the code in minutes. With Gatsby's "component shadowing", I can instantly replace any default component and style it however I want. 
