...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This post will cover my opinion of JAMstack and the modern trend of micro-frontend meeting micro-services back-end; all connected via client-side Javascript and static HTML that's hosted at the edge of the CDN. Serverless, headless, git-centric, progressive web app development following best practices in CI/CD.
...
<div className="Image__Medium">
  <img
    ...
    title="Editing Gatsby Theme Novela"
    alt="Editing Gatsby Theme Novela"
  />
</div>
...
<div className="Image__Small">
  <img
    src="./images/edit.jpg"
    title="Editing Gatsby Config"
    alt="Editing Gatsby Config"
  />
</div>
...
<div className="Image__Small">
  <img
    src="./images/copylink-toggle_light_dark.jpg"
    title="Link Copy and Light/Dark Mode Toggle"
    alt="Link Copy and Light/Dark Mode Toggle"
  />
</div>
...
<div className="Image__Small">
  <img
    src="./images/highlight-to-share.jpg"
    title="Highlight To Share"
    alt="Highlight To Share"
  />
</div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**How is it possible that I can have a fully-functioning**, dynamic **React web app with key blog functionality,** features like lazy-loading/code splitting, fully customized and ready for CDN publishing **in under an hour?** 

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;It's called [Themes](https://www.gatsbyjs.org/docs/themes/) for [Gatsby JS](https://www.gatsbyjs.org/) (one of the many **static, progressive web app generators**). The beauty of JAMstack solutions like Gatsby is that they follow the micro-front end trend which views a website or webapp as a composition of features. Compontentization like this enables independent teams to collaborate on different front-end features that are encapsulated as independent packages and merged together in the end. As opposed to the old monolithic model, micro-frontends empower developers to work independently without concern of breaking the overall system. 
